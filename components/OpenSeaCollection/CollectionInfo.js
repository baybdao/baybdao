...
const CollectionInfo = ({
  ...
  return (
    <div className="mt-3 flex w-full flex-col rounded-xl border border-white p-3">
      ...
      <span className="mr-1 text-lg font-semibold">{floor.toFixed(1)} Floor</span>
      <span className="mr-1 text-lg font-semibold">{avg.toFixed(1)} Price</span>
      <span className="mr-1 text-lg font-semibold">{volume.toFixed(1)} Volume</span>
      </div>
